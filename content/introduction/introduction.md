...
PI Interface for Rockwell FactoryTalk Batch [!include[version](../includes/product-version.md)] is an event-based interface that collects data from Rockwell FactoryTalk Batch System <!-- TU: Link is broken -->. The interface performs the following actions:
